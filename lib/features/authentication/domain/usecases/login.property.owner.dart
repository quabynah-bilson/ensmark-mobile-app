...
final class LoginPropertyOwnerUseCase implements UseCase<AppUser, LoginParams> {
  const LoginPropertyOwnerUseCase(this._repo);

  final AuthRepository _repo;

  @override
  FutureOr<UseCaseResult<AppUser>> call(LoginParams params) async {
    final either = await _repo.login(role: UserRole.owner, username: params.username, password: params.password);
