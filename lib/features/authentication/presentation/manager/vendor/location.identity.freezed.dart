...
mixin _$LocationIdentityState {
 ...
 String get taxIdentificationNumber; String get houseNumber; String get street; String get digitalCode; String get landmark; String get town; String get region; String get addressLine1; String get addressLine2; String get addressLine3; String get addressLine4; String get country;
...
@override
int get hashCode => Object.hash(runtimeType,taxIdentificationNumber,houseNumber,street,digitalCode,landmark,town,region,addressLine1,addressLine2,addressLine3,addressLine4,country);

@override
String toString() {
  return 'LocationIdentityState(taxIdentificationNumber: $taxIdentificationNumber, houseNumber: $houseNumber, street: $street, digitalCode: $digitalCode, landmark: $landmark, town: $town, region: $region, addressLine1: $addressLine1, addressLine2: $addressLine2, addressLine3: $addressLine3, addressLine4: $addressLine4, country: $country)';
}
...
@useResult
$Res call({
 String taxIdentificationNumber, String houseNumber, String street, String digitalCode, String landmark, String town, String region, String addressLine1, String addressLine2, String addressLine3, String addressLine4, String country
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String taxIdentificationNumber,  String houseNumber,  String street,  String digitalCode,  String landmark,  String town,  String region,  String addressLine1,  String addressLine2,  String addressLine3,  String addressLine4,  String country)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LocationIdentityState() when $default != null:
return $default(_that.taxIdentificationNumber,_that.houseNumber,_that.street,_that.digitalCode,_that.landmark,_that.town,_that.region,_that.addressLine1,_that.addressLine2,_that.addressLine3,_that.addressLine4,_that.country);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String taxIdentificationNumber,  String houseNumber,  String street,  String digitalCode,  String landmark,  String town,  String region,  String addressLine1,  String addressLine2,  String addressLine3,  String addressLine4,  String country)  $default,) {final _that = this;
switch (_that) {
case _LocationIdentityState():
return $default(_that.taxIdentificationNumber,_that.houseNumber,_that.street,_that.digitalCode,_that.landmark,_that.town,_that.region,_that.addressLine1,_that.addressLine2,_that.addressLine3,_that.addressLine4,_that.country);case _:
  throw StateError('Unexpected subclass');
...
class _LocationIdentityState implements LocationIdentityState {
  const _LocationIdentityState({this.taxIdentificationNumber = '', this.houseNumber = '', this.street = '', this.digitalCode = '', this.landmark = '', this.town = '', this.region = '', this.addressLine1 = '', this.addressLine2 = '', this.addressLine3 = '', this.addressLine4 = '', this.country = 'GH'});
